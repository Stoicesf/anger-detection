...
from anger_detection.decision import AlarmState, AngerStateMachine, DecisionConfig, EmotionSmoother
...
def test_hits_one_fires_immediately():
    sm = AngerStateMachine(
        DecisionConfig(
            ema_alpha=1.0,
            threshold=0.7,
