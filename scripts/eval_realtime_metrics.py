...
from common import HOP_LENGTH, MODELS_DIR, N_FFT, N_MELS, SR, TIME_FRAMES  # noqa: E402
from decision import AngerStateMachine, DecisionConfig, AlarmState  # noqa: E402
from prepare_data import log_mel_full  # noqa: E402

CASIA = Path(r"E:\桌面\test\CASIA")
ANGRY_IDX = 2
...
def main():
    ...
    out_path = ROOT / "output" / "realtime_metrics_zh.json"
